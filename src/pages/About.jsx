        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '40px', marginBottom: '24px' }}>
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            <div style={{
              ...
              <motion.p
                style={{ fontSize: '17px', lineHeight: '2', color: '#e0e0e0', marginBottom: '20px', position: 'relative', zIndex: 1 }}
                initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
              >
                Hello! I'm <motion.strong
                  style={{ color: '#ff6b6b', fontSize: '18px' }}
              ...
              <motion.p
                style={{ fontSize: '16px', lineHeight: '1.9', color: '#b0b0b0', marginBottom: '20px', position: 'relative', zIndex: 1 }}
              ...
              <motion.p
                style={{ fontSize: '16px', lineHeight: '1.9', color: '#b0b0b0', position: 'relative', zIndex: 1 }}
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1 }} style={{ marginTop: '24px' }}>
              <h3 style={{ fontSize: '28px', color: '#ff6b6b', marginBottom: '20px', textShadow: '0 0 20px rgba(255,107,107,0.3)' }}>
                Interests & Hobbies
              </h3>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                {[
                  ...
                  >
                    ...
                    <span style={{ color: '#fff', fontWeight: '600', fontSize: '14px' }}>{interest.text}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          >
            {[
              ...
              >
                <motion.div
                  style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: `linear-gradient(135deg, ${stat.color}20, transparent)`, opacity: 0 }}
                ...
                <motion.div
                  style={{ fontSize: '32px', fontWeight: '700', color: stat.color, marginBottom: '6px' }}
                  initial={{ scale: 0 }} animate={{ scale: 1 }}
                  transition={{ delay: 0.8 + index * 0.1, type: 'spring' }}
                >
                  {stat.number}
                </motion.div>
                <div style={{ color: '#b0b0b0', fontSize: '14px' }}>{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
